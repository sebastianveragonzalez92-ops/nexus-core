  ...
  const groups = [
    ...
    },
    {
      ...
      items: [
        ...
        ...(['admin', 'supervisor_mantenimiento'].includes(userRole) ? [{ name: 'Crear Tarea', page: 'CreateTask', icon: ClipboardList }] : []),
      ],
    },
    {
      label: 'General',
            ...
            {navGroups.map((group, gi) => (
              <div key={gi}>
                {group.label && !isCollapsed && (
                  <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 px-4 mb-1">
                    {group.label}
                  </p>
                )}
                ...
                <div className="space-y-0.5">
                  {group.items.map(({ name, page, icon: Icon }) => {
                    ...
                    return (
                      <Link
                        ...
                        style={isActive ? {
                          ...
                          boxShadow: `0 8px 12px -3px ${brandColor}33`
                        } : {}}
                      >
